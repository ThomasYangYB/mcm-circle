  ...
  return (
    <Screen title="방문 스탬프 발급" back preset="wide" caHeader>
      ...
      <View style={[s.issueDetailColumns, !isTablet && s.issueDetailColumnsMobile]}>
        <View style={s.issueVisual}><StoreStampImage storeName={currentStore} size={126} lightPlate /><Text style={s.issueVisualStore}>{currentStore}</Text><Text style={s.issueVisualCaption}>OFFICIAL JOURNEY STAMP</Text></View>
...
const s = StyleSheet.create({
  ...
  // 태블릿은 별도 스타일을 유지한다.
  loginLogo: { width: 326, height: 123, alignSelf: "flex-start", marginLeft: -18, marginTop: 8 },
  // 실제 로고 픽셀은 잘리지 않는다.
  ...
  headerHome: { height: 64, paddingHorizontal: 8 },
  headerMark: {
    width: 42,
    height: 42,
    alignItems: "center",
  ...
  headerHomeMark: { width: 180, height: 62 },
  headerLogo: { width: 180, height: 64 },
  headerHomeLogo: { width: 176, height: 62, marginLeft: -12 },
