...
export type ConsultationRecordRequest = { visitPurpose: string; content: string; styleChange?: string; cautionUpdate?: string; consentConfirmed: boolean };
export type ConsultationRecordResponse = ConsultationRecordRequest & { recordId: number; visitId: number; storeName: string; caName: string; createdAt: string };
